...
pub trait VisualizerSystem: Send + Sync + 'static {
    ...
    /// Determines which entities out of a set of applicable entities (entities that have all required components),
    /// are *not* included in the set of visualizable entities.
    ///
